/*
 * SSMprotocol_def_en.cpp - SSM-protocol-definitions
 *
...
#include "SSMprotocol_def_en.h"
	...
	SSMprotocol_def_en::SSMprotocol_def_en()
	{
		...
		<< "1;4;1;0;00000B;;Air/Fuel Correction #2;%;-128/128*100;1"
		<< "1;5;1;0;00000A;;Air/Fuel Learning #1;%;-128/128*100;1"
		<< "1;6;1;0;000009;;Air/Fuel Correction #1;%;-128/128*100;1"
		<< "1;7;1;0;000008;;Coolant Temperature;°C;-40;0"
		<< "1;8;1;0;000007;;Engine Load;%;/255*100;1"
		<< "2;1;1;0;00001B;00001A;Front O2 Sensor #2 Voltage;V;/200;3"
		<< "2;2;1;0;000019;000018;Rear O2 Sensor Voltage;V;/200;3"
		<< "2;3;1;0;000017;000016;Front O2 Sensor #1 Voltage;V;/200;3"
		<< "2;4;1;0;000015;;Throttle Opening Angle;%;/255*100;1"
		<< "2;5;1;0;000014;000013;Mass Air Flow;g/s;/100;2"
		<< "2;6;1;0;000012;;Intake Air Temperature;°C;-40;0"
		<< "2;7;1;0;000011;;Ignition Timing;deg;-128/2;1"
		<< "2;8;1;0;000010;;Vehicle Speed;km/h;*1;0"
		<< "3;1;1;0;000023;;Atmosphere Pressure;kPa;*1;0"
		<< "3;2;1;0;000022;;Knocking Correction;deg;-128/2;1"
		<< "3;3;1;0;000021;;Fuel Injection #2 Pulse;ms;*256/1000;2"
		<< "3;4;1;0;000020;;Fuel Injection #1 Pulse;ms;*256/1000;2"
		<< "3;5;1;0;00001F;;Differential Pressure Sensor Voltage;V;/50;2"
		<< "3;6;1;1;00001E;;Throttle Sensor Voltage;V;/50;2"
		<< "3;7;1;1;00001D;;Air Flow Sensor Voltage;V;/50;2"
		<< "3;8;1;1;00001C;;Battery Voltage;V;*2/25;1"
		<< "4;1;1;0;00002B;;Front O2 Sensor #1 Heater Current;A;/255*10;2"
		<< "4;2;1;0;00002A;;Fuel Temperature;°C;-40;0"
		<< "4;3;1;1;000029;;Accelerator Pedal Travel;%;/255*100;1"
		<< "4;4;1;0;000028;;Learned Ignition Timing;deg;-128/2;1"
		<< "4;5;1;0;000027;;CO Adjustment Voltage;V;/50;2"
		<< "4;6;1;0;000026;;Fuel Tank Pressure;kPa;-128/40;2"
		<< "4;7;1;0;000025;;Pressure Differential Sensor;kPa;-128;0"
		<< "4;8;1;0;000024;;Manifold Relative Pressure;kPa;-128;0"
		<< "5;1;1;0;000033;;Tumble Generator Valve (TGV) Position Sensor (Right);V;/50;2"
		<< "5;2;1;0;000032;;Canister Purge Control (CPC) Valve Duty Ratio;%;/255*100;0"
		<< "5;3;1;0;000031;;Secondary Wastegate Duty Cycle;%;/255*100;1"
		<< "5;4;1;0;000030;;Primary Wastegate Duty Cycle;%;/255*100;1"
		<< "5;5;1;0;00002F;;Radiator Fan Control;%;*1;0"
		<< "5;6;1;0;00002E;;Fuel Level Sensor Voltage;V;/50;2"
		<< "5;7;1;0;00002D;;Front O2 Sensor #2 Heater Current;A;/255*10;2"
		<< "5;8;1;0;00002C;;Rear O2 Sensor Heater Current;A;/255*10;2"
		<< "6;1;1;0;00003B;;Fuel Pump Duty;%;/255*100;0"
		<< "6;2;1;0;00003A;;Alternator Duty;%;*1;0"
		<< "6;3;1;0;000039;;Number of Exhaust Gas Recirculation (EGR) Steps;steps;*1;0"
		<< "6;4;1;0;000038;;Idle Speed Control (ISC) Valve Steps;steps;*1;0"
		<< "6;5;1;0;000037;;Air/Fuel Heater Duty;%;/255*100;1"
		<< "6;6;1;0;000036;;Air/Fuel Lean Correction;%;/255*100;0"
		<< "6;7;1;0;000035;;Idle Speed Control (ISC) Valve Duty Ratio;%;/2;1"
		<< "6;8;1;0;000034;;Tumble Generator Valve (TGV) Position Sensor (Left);V;/50;2"
		<< "7;1;1;0;000043;;Air/Fuel Sensor #2 Current;mA;-128/8;2"
		<< "7;2;1;0;000042;;Air/Fuel Sensor #1 Current;mA;-128/8;2"
		<< "7;3;1;0;000041;;Oil Flow Control Solenoid Valve (OCV) Current (Left, Intake);mA;*32;0"
		<< "7;4;1;0;000040;;Oil Flow Control Solenoid Valve (OCV) Current (Right, Intake);mA;*32;0"
		<< "7;5;1;0;00003F;;Oil Flow Control Solenoid Valve (OCV) Duty (Left, Intake);%;/255*100;1"
		<< "7;6;1;0;00003E;;Oil Flow Control Solenoid Valve (OCV) Duty (Right, Intake);%;/255*100;1"
		<< "7;7;1;0;00003D;;Variable Valve Timing (VVT) Advance Angle Amount (Left, Intake);deg;-50;0"
		<< "7;8;1;0;00003C;;Variable Valve Timing (VVT) Advance Angle Amount (Right, Intake);deg;-50;0"
		<< "8;1;1;0;0000D3;;Air/Fuel Adjust Voltage;V;/50;2"
		<< "8;2;1;0;0000D2;;Rear O2 Sensor Heater Voltage;V;/50;2"
		<< "8;3;1;0;0000D1;;Air/Fuel Learning #3;%;-128/128*100;2"
		<< "8;4;1;0;0000D0;;Air/Fuel Correction #3;%;-64/128*10;2"
		<< "8;5;1;0;000047;;Air/Fuel Sensor #2 Lambda;;/128;2"
		<< "8;6;1;0;000046;;Air/Fuel Sensor #1 Lambda;;/128;2"
		<< "8;7;1;0;000045;;Air/Fuel Sensor #2 Resistance;ohms;*1;0"
		<< "8;8;1;0;000044;;Air/Fuel Sensor #1 Resistance;ohms;*1;0"
		...
		<< "33;5;1;0;000103;;Main-Accelerator Sensor Voltage;V;/50;2"
		<< "33;6;1;1;000102;;Sub-Accelerator Sensor Voltage;V;/50;2"
		<< "33;7;1;0;000101;;Main-Throttle Sensor Voltage;V;/50;2"
		<< "33;8;1;0;000100;;Sub-Throttle Sensor Voltage;V;/50;2"
		<< "34;1;1;0;000173;000172;Fuel Tank Air Presser Pressure;MPa;/100;1"
		<< "34;2;1;0;00010F;00010E;Odometer;km;*2;0"
		<< "34;3;1;0;00010D;;Fuel Level Sensor Resistance;ohms;*4/2;1"
		<< "34;4;1;0;00010C;;Air/Fuel Learning #4;%;-128/128*100;2"
		<< "34;5;1;0;00010B;;Air/Fuel Correction #4;%;-64/128*10;2"
		<< "34;6;1;0;00010A;;Memorized Cruise Speed;km/h;*1;0"
		<< "34;7;1;0;000183;000182;Secondary Air Flow;g/s;/100;2"
		<< "34;8;1;0;000108;;Secondary Air Piping Pressure;kPa;*1;0"
		<< "35;1;1;0;000117;;Oil Switching Solenoid Valve (OSV) Current (Left);mA;*32;0"
		<< "35;2;1;0;000116;;Oil Switching Solenoid Valve (OSV) Current (Right);mA;*32;0"
		<< "35;3;1;0;000115;;Oil Switching Solenoid Valve (OSV) Duty (Left);%;/255*100;1"
		<< "35;4;1;0;000114;;Oil Switching Solenoid Valve (OSV) Duty (Right);%;/255*100;1"
		<< "35;5;1;0;000113;;Oil Temperature;°C;-40;0"
		<< "36;2;1;0;00011E;;VVL Lift Mode;;*1;0"
		<< "36;3;1;0;00011D;;Oil Flow Control Solenoid Valve (OCV) Current (Left, Exhaust);mA;*32;0"
		<< "36;4;1;0;00011C;;Oil Flow Control Solenoid Valve (OCV) Current (Right, Exhaust);mA;*32;0"
		<< "36;5;1;0;00011B;;Oil Flow Control Solenoid Valve (OCV) Duty (Left, Exhaust);%;/255*100;1"
		<< "36;6;1;0;00011A;;Oil Flow Control Solenoid Valve (OCV) Duty (Right, Exhaust);%;/255*100;1"
		<< "36;7;1;0;000119;;Variable Valve Timing (VVT) Retard Angle (Left, Exhaust);deg;-50;0"
		<< "36;8;1;0;000118;;Variable Valve Timing (VVT) Retard Angle (Right, Exhaust);deg;-50;0"
		<< "43;1;0;1;000147;;Yaw Rate Sensor Voltage;V;/51;2"
		<< "43;2;0;1;000146;;AWD Solenoid Valve Current;A;/255;2"
		<< "43;3;0;1;000145;;L/U Solenoid Valve Current;A;/255;2"
		<< "43;4;0;1;000144;;P/L Solenoid Valve Current;A;/255;2"
		<< "43;5;0;1;000143;;I/C Solenoid Valve Current;A;/255;2"
		<< "43;6;0;1;000142;;F/B Solenoid Valve Current;A;/255;2"
		<< "43;7;0;1;000141;;D/C Solenoid Valve Current;A;/255;2"
		<< "43;8;0;1;000140;;H&LR/C Solenoid Valve Current;A;/255;2"
		<< "44;1;0;1;00014F;;Yaw Rate & G Sensor Reference Voltage;V;/51;2"
		<< "44;2;0;1;00014E;;AWD Solenoid Valve Pressure;kPa;*10;0"
		<< "44;3;0;1;00014D;;L/U Solenoid Valve Pressure;kPa;*10;0"
		<< "44;4;0;1;00014C;;P/L Solenoid Valve Pressure;kPa;*10;0"
		<< "44;5;0;1;00014B;;I/C Solenoid Valve Pressure;kPa;*10;0"
		<< "44;6;0;1;00014A;;F/B Solenoid Valve Pressure;kPa;*10;0"
		<< "44;7;0;1;000149;;D/C Solenoid Valve Pressure;kPa;*10;0"
		...
		<< "45;8;0;1;00013C;;Wheel Speed Front Right;km/h;*1;0"
		<< "48;1;1;0;000199;;Knocking Correction;deg;-128/4;1"
		<< "48;2;1;0;0000F9;;Learned Ignition Timing Correction;deg;/16;1"
		<< "48;3;1;0;0000F8;;Roughness Monitor Cylinder #6;;*1;0"
		<< "48;4;1;0;0000EF;;Roughness Monitor Cylinder #5;;*1;0"
		<< "48;5;1;0;0000D9;;Roughness Monitor Cylinder #4;;*1;0"
		<< "48;6;1;0;0000D8;;Roughness Monitor Cylinder #3;;*1;0"
		<< "48;7;1;0;0000CF;;Roughness Monitor Cylinder #2;;*1;0"
		<< "48;8;1;0;0000CE;;Roughness Monitor Cylinder #1;;*1;0"
		<< "52;8;1;0;00019A;;Fuel Tank Pressure;kPa;-128/20;2"
		...
		<< "12;5;1;0;000061;Read Memory Signal;Off/On"
		<< "12;6;1;0;000061;Test Mode Signal;Off/On"
		<< "12;7;1;0;000061;AT Vehicle ID;Off/On"
		<< "13;2;1;0;000062;Air Conditioning Switch;Off/On"
		<< "13;3;1;0;000062;Power Steering Switch;Off/On"
		<< "13;4;1;1;000062;Ignition Switch;Off/On"
		<< "13;5;1;0;000062;Intercooler Auto Washer Switch;Off/On"
		<< "13;7;1;0;000062;Idle Switch;Off/On"
		<< "13;8;1;1;000062;Neutral Position Switch;Off/On"
		<< "14;1;1;0;000063;Electrical Load Signal;Off/On"
		<< "14;2;1;0;000063;Knocking Signal #2;Off/On"
		<< "14;3;1;0;000063;Knocking Signal #1;Off/On"
		<< "14;4;1;0;000063;Front O2 Sensor #2 Rich Signal;Off/On"
		<< "14;5;1;0;000063;Rear O2 Sensor Rich Signal;Off/On"
		<< "14;6;1;0;000063;Front O2 Sensor #1 Rich Signal;Off/On"
		<< "14;7;1;0;000063;Starter Switch;Off/On"
		<< "14;8;1;0;000063;Handle Switch;High Input/Low Input"
		<< "15;1;1;0;000064;Air Conditioning Mid Pressure Switch;Off/On"
		<< "15;2;1;0;000064;Air Conditioning Lock Signal;Off/On"
		<< "15;3;1;0;000064;Wiper Switch;Off/On"
		<< "15;4;1;0;000064;Light Switch;Off/On"
		<< "15;5;1;0;000064;Blower Fan Switch;Off/On"
		<< "15;6;1;0;000064;Rear Defogger Switch;Off/On"
		<< "15;7;1;0;000064;Camshaft Position Signal;Off/On"
		<< "15;8;1;0;000064;Crankshaft Position Signal;Off/On"
		<< "16;1;1;0;000065;Blow-By Leak Connector;Off/On"
		<< "16;2;1;0;000065;Canister Purge Control (CPC) Solenoid Valve;Off/On"
		<< "16;3;1;0;000065;Intercooler Auto Washer Relay;Off/On"
		<< "16;4;1;0;000065;Fuel Pump Relay;Off/On"
		<< "16;5;1;0;000065;Radiator Fan Relay #2;Off/On"
		<< "16;6;1;0;000065;Radiator Fan Relay #1;Off/On"
		<< "16;7;1;0;000065;Radiator Fan Relay #3;Off/On"
		<< "16;8;1;0;000065;Air Conditioning Compressor Signal;Off/On"
		<< "17;1;1;0;000066;Assist Air Solenoid Valve;Off/On"
		<< "17;2;1;0;000066;Power Steering Solenoid Valve;Off/On"
		<< "17;3;1;0;000066;Ventilation Solenoid Valve;Off/On"
		<< "17;4;1;0;000066;Pressure Sources Change;Off/On"
		<< "17;5;1;0;000066;Variable Intake Air Solenoid;Off/On"
		<< "17;6;1;0;000066;Tumble Generator Valve (TGV) Drive;Close/Open"
		<< "17;7;1;0;000066;Tumble Generator Valve (TGV) Output;Off/On"
		<< "17;8;1;0;000066;Positive Crankcase Ventilation (PCV) Solenoid Valve;Off/On"
		<< "18;1;1;0;000067;Muffler Control;Off/On"
		<< "18;2;1;0;000067;Intake Air Solenoid;Off/On"
		<< "18;3;1;0;000067;Exhaust Gas Negative Pressure;Off/On"
		<< "18;4;1;0;000067;Exhaust Gas Positive Pressure;Off/On"
		<< "18;5;1;0;000067;Traction Control System (TCS) Relief Valve Solenoid;Off/On"
		<< "18;6;1;0;000067;Relief Valve Solenoid #2;Off/On"
		<< "18;7;1;0;000067;Relief Valve Solenoid #1;Off/On"
		<< "18;8;1;0;000067;Tank Sensor Control Valve;Off/On"
		<< "19;1;1;0;000068;Request Torque Down VDC;Off/On"
		<< "19;2;1;0;000068;Ban of Torque Down;On/Off"
		<< "19;3;1;0;000068;Fuel Cut Signal From AT;Off/On"
		<< "19;4;1;0;000068;Retard Signal From AT;Off/On"
		<< "19;5;1;0;000068;Canister Purge Control (CPC) Solenoid Valve #2;Off/On"
		<< "19;6;1;0;000068;Engine Oil Pressure Switch #2;Off/On"
		<< "19;7;1;0;000068;Engine Oil Pressure Switch #1;Off/On"
		<< "19;8;1;0;000068;Exhaust By-Pass Valve;Off/On"
		<< "20;1;1;0;000069;AT Engine Torque Request (AET) Signal;High/Low"
		<< "20;2;1;0;000069;AT Cooperation Rich Spike Signal;Off/On"
		<< "20;3;1;0;000069;AT Cooperation Lean Burn Signal;Off/On"
		<< "20;4;1;0;000069;AT Cooperation Lock Up Signal;Off/On"
		<< "20;5;1;0;000069;Engine AT Masking Flag (EAM) Signal;High/Low"
		<< "20;6;1;0;000069;Torque Permission Signal;Off/On"
		<< "20;7;1;0;000069;Torque Control Signal #2;Off/On"
		<< "20;8;1;0;000069;Torque Control Signal #1;Off/On"
		<< "21;1;0;1;00006A;Front Wheel Drive (FWD) Switch;Off/On"
		<< "21;2;1;1;00006A;Kick Down Switch;Off/On"
		<< "21;3;0;1;00006A;Upshift Switch;Off/On"
		<< "21;4;0;1;00006A;Stop Light Switch;Off/On"
		<< "21;5;0;1;00006A;Downshift Switch;Off/On"
		<< "21;6;0;1;00006A;ABS Signal;Off/On"
		<< "21;7;0;1;00006A;Cruise Control Signal;Off/On"
		<< "21;8;0;1;00006A;Tiptronic Mode Switch;Off/On"
		<< "22;1;0;1;00006B;N/P Range Signal;Off/On"
		<< "22;2;0;1;00006B;R Range Signal;Off/On"
		<< "22;3;0;1;00006B;D Range Signal;Off/On"
		<< "22;4;0;1;00006B;3rd Range Signal;Off/On"
		<< "22;5;0;1;00006B;2nd Range Signal;Off/On"
		<< "22;6;0;1;00006B;1st Range Signal;Off/On"
		<< "22;7;0;1;00006B;Hold Mode Switch;Off/On"
		<< "22;8;0;1;00006B;Power Mode Switch;Off/On"
		<< "23;1;0;1;00006C;Shift Solenoid #1;Off/On"
		<< "23;2;0;1;00006C;Shift Solenoid #2;Off/On"
		<< "23;3;0;1;00006C;Low Clutch Timing Solenoid;Off/On"
		<< "23;4;0;1;00006C;2-4 Brake Timing Solenoid;Off/On"
		<< "23;5;0;1;00006C;Torque Control Signal #2;Off/On"
		<< "23;6;0;1;00006C;Torque Control Signal #1;Off/On"
		<< "23;7;0;1;00006C;Tiptronic Solenoid;Off/On"
		<< "23;8;0;1;00006C;4th Range Signal;Off/On"
		<< "24;1;0;1;00006D;Shift Lock Solenoid;Off/On"
		<< "24;2;0;1;00006D;ATF Temperature Lamp;Off/On"
		<< "24;3;0;1;00006D;Rear Differential Oil Temperature Switch;Off/On"
		<< "24;4;0;1;00006D;Diagnosis Lamp;Off/On"
		<< "24;5;0;1;00006D;Shift Output 1;Off/On"
		<< "24;6;0;1;00006D;Shift Output 2;Off/On"
		<< "24;7;0;1;00006D;Shift Output 3;Off/On"
		<< "24;8;0;1;00006D;Shift Output 4;Off/On"
		<< "25;1;0;1;00006E;N Range;Off/On"
		<< "25;2;0;1;00006E;Hold Lamp;Off/On"
		<< "25;3;0;1;00006E;Traction Control System (TCS) Switch;Off/On"
		<< "25;4;0;1;00006E;P/N Signal;Off/On"
		<< "25;5;0;1;00006E;Torque Control Cut Signal;Off/On"
		<< "25;6;0;1;00006E;P Range;Off/On"
		<< "25;7;0;1;00006E;Power Mode Lamp;Off/On"
		<< "25;8;1;1;00006E;Economy Switch;Off/On"
		<< "28;1;0;1;0000D4;AT Power Relay;Off/On"
		<< "28;2;0;1;0000D4;Back Lamp Relay;Off/On"
		<< "28;3;0;1;0000D4;Inhibitor Switch #3 Monitor;Low/High"
		<< "28;4;0;1;0000D4;Inhibitor Switch #4;Low/High"
		<< "28;5;0;1;0000D4;Inhibitor Switch #3;Low/High"
		<< "28;6;0;1;0000D4;Inhibitor Switch #2;Low/High"
		<< "28;7;0;1;0000D4;Inhibitor Switch #1;Low/High"
		<< "28;8;0;1;0000D4;Judgement of All Wheel Drive (AWD);Off/On"
		<< "32;1;0;1;0000D5;Signal of Identified Electronic Control Module (ECM);Off/On"
		<< "32;2;0;1;0000D5;LC/B Fluid Pressure;Off/On"
		<< "32;3;0;1;0000D5;I/C Fluid Pressure;Off/On"
		<< "32;4;0;1;0000D5;F/B Fluid Pressure;Off/On"
		<< "32;5;0;1;0000D5;D/C Fluid Pressure;Off/On"
		<< "32;6;0;1;0000D5;H&LR/C Fluid Pressure;Off/On"
		<< "37;6;1;0;000120;Injector Driver Relay;Off/On"
		<< "37;7;1;0;000120;Electronic Throttle Control (ETC) Motor Relay;Off/On"
		<< "37;8;1;0;000120;Idle Switch;Off/On"
		<< "38;1;1;1;000121;Cruise Control Status;Off/On"
		<< "38;2;1;0;000121;Main (Cruise) Switch;Off/On"
		<< "38;3;1;0;000121;Inhibitor Switch;Off/On"
		<< "38;4;1;0;000121;Brake Switch;Off/On"
		<< "38;5;1;0;000121;Resume/Accelerate Switch;Off/On"
		<< "38;6;1;0;000121;Set/Coast Switch;Off/On"
		<< "38;7;1;0;000121;Stop Light Switch;Off/On"
		<< "38;8;1;0;000121;Clutch Switch;Off/On"
		<< "39;1;0;1;000122;Center Differential Lamp 6;Off/On"
		<< "39;2;0;1;000122;Center Differential Lamp 5;Off/On"
		<< "39;3;0;1;000122;Center Differential Lamp 4;Off/On"
		<< "39;4;0;1;000122;Center Differential Lamp 3;Off/On"
		<< "39;5;0;1;000122;Center Differential Lamp 2;Off/On"
		<< "39;6;0;1;000122;Center Differential Lamp 1;Off/On"
		<< "39;7;0;1;000122;LU&FWD/B Solenoid Valve;Off/On"
		<< "39;8;0;1;000122;LC/B Solenoid Valve;Off/On"
		<< "46;4;0;1;0000D6;Fwd/B Hydraulic Pressure Switch;Off/On"
		<< "46;5;0;1;0000D6;AUTO Mode Lamp;Off/On"
		<< "46;6;0;1;0000D6;AUTO/MANUAL Mode Switch;Off/On"
		<< "46;7;0;1;0000D6;Center Differential Relay;Off/On"
		<< "46;8;0;1;0000D6;Parking Position Switch;Off/On"
		<< "47;1;1;0;0000D7;Cruise Control Cancel Switch;Off/On"
		<< "47;2;1;0;0000D7;Distance Change Switch;Off/On"
		<< "47;3;1;0;0000D7;Secondary Air Combi Valve Relay #1;Off/On"
		<< "47;4;1;0;0000D7;Secondary Air Pump Relay;Off/On"
		<< "47;5;1;0;0000D7;Secondary Air Combi Valve Relay #2;Off/On"
		<< "47;7;1;0;0000D7;Body Integrated Unit Count;On/Off"
		<< "47;8;1;0;0000D7;Body Integrated Unit Data;On/Off"
		<< "49;8;1;0;000196;Malfunction Indicator Light (MIL) ON Flag;Off/On"
		<< "50;1;1;0;000197;Injector Learning;Not Completed/Completed"
		<< "50;2;1;0;000197;Fuel Pump Learning;Not Completed/Completed"
		<< "50;4;1;0;000197;Sub Fuel Pump Relay;Off/On"
		<< "50;6;1;0;000197;Glow Relay;Off/On"
		<< "50;7;1;0;000197;Exhaust Gas Recirculation (EGR) Control Mode;Open/Feedback"
		<< "50;8;1;0;000197;Boost Pressure Control Mode;Open/Feedback"
		<< "62;5;1;0;0001CE;Clutch Switch for Smart-System;Off/On"
		<< "62;6;1;0;0001CE;Fuel Pump Mode;Open/Feedback"
		<< "62;7;1;0;0001CE;Fuel Cut;Not Requested/Requested"
		<< "62;8;1;0;0001CE;Exhaust Gas Recirculation (EGR) Learning;Not Completed/Completed";
		...
		<< "000095;0000AB;2;??;UNKNOWN (Address 95/AB Bit 2)"
		...
		<< "000098;0000AE;1;??;UNKNOWN (Address 98/AE Bit 1)"
		<< "000098;0000AE;2;??;UNKNOWN (Address 98/AE Bit 2)"
		<< "000098;0000AE;3;??;UNKNOWN (Address 98/AE Bit 3)"
		<< "000098;0000AE;4;??;UNKNOWN (Address 98/AE Bit 4)"
		<< "000098;0000AE;5;??;UNKNOWN (Address 98/AE Bit 5)"
		<< "000098;0000AE;6;??;UNKNOWN (Address 98/AE Bit 6)"
		<< "000098;0000AE;7;??;UNKNOWN (Address 98/AE Bit 7)"
		<< "000098;0000AE;8;??;UNKNOWN (Address 98/AE Bit 8)";
		...
		<< "00008E;0000AE;6;P????;UNKNOWN (Address 8E/AE Bit 6)"
		...
		<< "000093;0000B3;3;P????;UNKNOWN (Address 93/B3 Bit 3)"
		...
		<< "0000A8;0000C8;2;P1491;Positive Crankcase Ventilation (Blow-by) Function Problem"
		...
		<< "0000AB;0000CB;1;P1577;Immobilizer Control Module EEPROM"
		<< "0000AB;0000CB;2;P1576;Electronic Gasoline Injection (EGI) Control Module EEPROM"
		...
		<< "0000AC;0000CC;1;P1095;Tumble Generator Valve (TGV) Signal 1 Circuit Malfunction (Short)"
		<< "0000AC;0000CC;2;P1097;Tumble Generator Valve (TGV) Signal 2 Circuit Malfunction (Short)"
		<< "0000AC;0000CC;3;P1094;Tumble Generator Valve (TGV) Signal 1 Circuit Malfunction (Open)"
		<< "0000AC;0000CC;4;P1096;Tumble Generator Valve (TGV) Signal 2 Circuit Malfunction (Open)"
		...
		<< "0000AD;0000CD;5;P1306;OCV Solenoid Valve Signal 1 Circuit Malfunction (Open)"
		<< "0000AD;0000CD;6;P1308;OCV Solenoid Valve Signal 2 Circuit Malfunction (Open)"
		<< "0000AD;0000CD;7;P1307;OCV Solenoid Valve Signal 1 Circuit Malfunction (Short)"
		<< "0000AD;0000CD;8;P1309;OCV Solenoid Valve Signal 2 Circuit Malfunction (Short)"
		...
		<< "000174;00017B;2;P????;UNKNOWN (Address 174/17B Bit 2)"
		<< "000174;00017B;3;P????;UNKNOWN (Address 174/17B Bit 3)"
		<< "000174;00017B;4;P????;UNKNOWN (Address 174/17B Bit 4)"
		<< "000174;00017B;5;P????;UNKNOWN (Address 174/17B Bit 5)"
		<< "000174;00017B;6;P????;UNKNOWN (Address 174/17B Bit 6)"
		<< "000174;00017B;7;P????;UNKNOWN (Address 174/17B Bit 7)"
		<< "000174;00017B;8;P????;UNKNOWN (Address 174/17B Bit 8)"
		...
		<< "00017A;000181;3;P????;UNKNOWN (Address 17A/181 Bit 3)"
		<< "00017A;000181;4;P????;UNKNOWN (Address 17A/181 Bit 4)"
		...
		<< "0001C1;0001C7;1;P????;UNKNOWN (Address 1C1/1C7 Bit 1)"
		<< "0001C1;0001C7;2;P????;UNKNOWN (Address 1C1/1C7 Bit 2)"
		<< "0001C1;0001C7;3;P????;UNKNOWN (Address 1C1/1C7 Bit 3)"
		<< "0001C1;0001C7;4;P????;UNKNOWN (Address 1C1/1C7 Bit 4)"
		<< "0001C1;0001C7;5;P????;UNKNOWN (Address 1C1/1C7 Bit 5)"
		<< "0001C1;0001C7;6;P????;UNKNOWN (Address 1C1/1C7 Bit 6)"
		<< "0001C1;0001C7;7;P????;UNKNOWN (Address 1C1/1C7 Bit 7)"
		<< "0001C1;0001C7;8;P????;UNKNOWN (Address 1C1/1C7 Bit 8)"
		<< "0001C2;0001C8;1;P????;UNKNOWN (Address 1C2/1C8 Bit 1)"
		<< "0001C2;0001C8;2;P????;UNKNOWN (Address 1C2/1C8 Bit 2)"
		<< "0001C2;0001C8;3;P????;UNKNOWN (Address 1C2/1C8 Bit 3)"
		<< "0001C2;0001C8;4;P????;UNKNOWN (Address 1C2/1C8 Bit 4)"
		<< "0001C2;0001C8;5;P????;UNKNOWN (Address 1C2/1C8 Bit 5)"
		<< "0001C2;0001C8;6;P????;UNKNOWN (Address 1C2/1C8 Bit 6)"
		<< "0001C2;0001C8;7;P????;UNKNOWN (Address 1C2/1C8 Bit 7)"
		<< "0001C2;0001C8;8;P????;UNKNOWN (Address 1C2/1C8 Bit 8)"
		<< "0001C3;0001C9;1;P????;UNKNOWN (Address 1C3/1C9 Bit 1)"
		<< "0001C3;0001C9;2;P????;UNKNOWN (Address 1C3/1C9 Bit 2)"
		<< "0001C3;0001C9;3;P????;UNKNOWN (Address 1C3/1C9 Bit 3)"
		<< "0001C3;0001C9;4;P????;UNKNOWN (Address 1C3/1C9 Bit 4)"
		<< "0001C3;0001C9;5;P????;UNKNOWN (Address 1C3/1C9 Bit 5)"
		<< "0001C3;0001C9;6;P????;UNKNOWN (Address 1C3/1C9 Bit 6)"
		<< "0001C3;0001C9;7;P????;UNKNOWN (Address 1C3/1C9 Bit 7)"
		<< "0001C3;0001C9;8;P????;UNKNOWN (Address 1C3/1C9 Bit 8)"
		<< "0001C4;0001CA;1;P????;UNKNOWN (Address 1C4/1CA Bit 1)"
		<< "0001C4;0001CA;2;P????;UNKNOWN (Address 1C4/1CA Bit 2)"
		<< "0001C4;0001CA;3;P????;UNKNOWN (Address 1C4/1CA Bit 3)"
		<< "0001C4;0001CA;4;P????;UNKNOWN (Address 1C4/1CA Bit 4)"
		<< "0001C4;0001CA;5;P????;UNKNOWN (Address 1C4/1CA Bit 5)"
		...
		<< "0001C5;0001CB;5;P????;UNKNOWN (Address 1C5/1CB Bit 5)"
		<< "0001C5;0001CB;6;P????;UNKNOWN (Address 1C5/1CB Bit 6)"
		<< "0001C5;0001CB;7;P????;UNKNOWN (Address 1C5/1CB Bit 7)"
		<< "0001C5;0001CB;8;P????;UNKNOWN (Address 1C5/1CB Bit 8)"
		<< "0001C6;0001CC;1;P????;UNKNOWN (Address 1C6/1CC Bit 1)"
		<< "0001C6;0001CC;2;P????;UNKNOWN (Address 1C6/1CC Bit 2)"
		...
		<< "00020A;00020E;4;P????;UNKNOWN (Address 20A/20E Bit 4)"
		<< "00020A;00020E;5;P????;UNKNOWN (Address 20A/20E Bit 5)"
		<< "00020A;00020E;6;P????;UNKNOWN (Address 20A/20E Bit 6)"
		<< "00020A;00020E;7;P????;UNKNOWN (Address 20A/20E Bit 7)"
		<< "00020A;00020E;8;P????;UNKNOWN (Address 20A/20E Bit 8)"
		<< "00020B;00020F;1;P????;UNKNOWN (Address 20B/20F Bit 1)"
		<< "00020B;00020F;2;P????;UNKNOWN (Address 20B/20F Bit 2)"
		<< "00020B;00020F;3;P????;UNKNOWN (Address 20B/20F Bit 3)"
		<< "00020B;00020F;4;P????;UNKNOWN (Address 20B/20F Bit 4)"
		<< "00020B;00020F;5;P????;UNKNOWN (Address 20B/20F Bit 5)"
		...
		<< "00020C;000210;6;P????;UNKNOWN (Address 20C/210 Bit 6)"
		<< "00020C;000210;7;P????;UNKNOWN (Address 20C/210 Bit 7)"
		<< "00020C;000210;8;P????;UNKNOWN (Address 20C/210 Bit 8)"
		<< "00020D;000211;1;P????;UNKNOWN (Address 20D/211 Bit 1)"
		<< "00020D;000211;2;P????;UNKNOWN (Address 20D/211 Bit 1)"
		<< "00020D;000211;3;P????;UNKNOWN (Address 20D/211 Bit 1)"
		<< "00020D;000211;4;P????;UNKNOWN (Address 20D/211 Bit 1)"

/*
 * CUcontent_DCs_aircon.cpp - Widget for TCU Diagnostic Codes Reading
 *
...
CUcontent_DCs_aircon::CUcontent_DCs_aircon(QWidget *parent) : CUcontent_DCs_abstract(parent)
{
...
CUcontent_DCs_aircon::~CUcontent_DCs_aircon()
{
...
bool CUcontent_DCs_aircon::setup(SSMprotocol *SSMPdev)
{
	bool ok = false;
...
void CUcontent_DCs_aircon::connectGUIelements()
{
	if (!_SSMPdev) return;
...
void CUcontent_DCs_aircon::disconnectGUIelements()
{
...
void CUcontent_DCs_aircon::updateCurrentOrTemporaryDTCsContent(QStringList currOrTempDTCs, QStringList currOrTempDTCdescriptions)
{
...
void CUcontent_DCs_aircon::updateHistoricOrMemorizedDTCsContent(QStringList histOrMemDTCs, QStringList histOrMemDTCdescriptions)
{
...
void CUcontent_DCs_aircon::createDCprintTables(QTextCursor cursor)
{
...
void CUcontent_DCs_aircon::resizeEvent(QResizeEvent *event)
{
...
bool CUcontent_DCs_aircon::eventFilter(QObject *obj, QEvent *event)
{
...
void CUcontent_DCs_aircon::setupUiFonts()
{
	// SET FONT FAMILY AND FONT SIZE
	// OVERWRITES SETTINGS OF ui_CUcontent_DCs_aircon.h (made with QDesigner)

/*
 * SSMprotocol_def_de.cpp - SSM-protocol-definitions
 *
...
#include "SSMprotocol_def_de.h"
	...
	SSMprotocol_def_de::SSMprotocol_def_de()
	{
		...
		<< "2;3;1;0;000017;000016;Vordere Lambdasonde Nr.1 Spannung;V;/200;3"
		<< "2;4;1;0;000015;;Drosselklappenöffnung;%;/255*100;1"
		<< "2;5;1;0;000014;000013;Luftmassenstrom;g/s;/100;2"
		<< "2;6;1;0;000012;;Ansauglufttemperatur;°C;-40;0"
		<< "2;7;1;0;000011;;Zündzeitpunkt;Grad;-128/2;1"
		<< "2;8;1;0;000010;;Fahrzeuggeschwindigkeit;km/h;*1;0"
		<< "3;1;1;0;000023;;Atmosphärendruck;kPa;*1;0"
		<< "3;2;1;0;000022;;Klopfkorrektur;Grad;-128/2;1"
		<< "3;3;1;0;000021;;Einspritzimpuls 2;ms;*256/1000;2"
		<< "3;4;1;0;000020;;Einspritzimpuls 1;ms;*256/1000;2"
		<< "3;5;1;0;00001F;;Differenzdrucksensor Spannung;V;/50;2"
		<< "3;6;1;1;00001E;;Drosselklappensensor Spannung;V;/50;2"
		<< "3;7;1;1;00001D;;Luftmassenmesser Spannung;V;/50;2"
		<< "3;8;1;1;00001C;;Batteriespannung;V;*2/25;1"
		<< "4;1;1;0;00002B;;Vordere Lambdasonde Nr.1 Heizstrom;A;/255*10;2"
		<< "4;2;1;0;00002A;;Kraftstofftemperatur;°C;-40;0"
		<< "4;3;1;1;000029;;Gaspedal-Betätigungsweg;%;/255*100;1"
		<< "4;4;1;0;000028;;Zündverstellung gelernt;Grad;-128/2;1"
		<< "4;5;1;0;000027;;CO-Einstellung Spannung;V;/50;2"
		<< "4;6;1;0;000026;;Kraftstofftankdruck;kPa;-128/40;2"
		<< "4;7;1;0;000025;;Differenzdrucksensor;kPa;-128;0"
		<< "4;8;1;0;000024;;Relativer Saugrohrdruck;kPa;-128;0"
		<< "5;1;1;0;000033;;Tumble-Ventil (TGV) Positionssensor (Rechts);V;/50;2"
		<< "5;2;1;0;000032;;Tankentlüftung/Aktivkohlebehälter (CPC) relative Einschaltdauer;%;/255*100;0"
		<< "5;3;1;0;000031;;Sekundäre Wastegate-Steuerung Arbeitszyklus;%;/255*100;1"
		<< "5;4;1;0;000030;;Primäre Wastegate-Steuerung Arbeitszyklus;%;/255*100;1"
		<< "5;5;1;0;00002F;;Kühlerlüfterregelung;%;*1;0"
		<< "5;6;1;0;00002E;;Kraftstoffstandsensor Spannung;V;/50;2"
		<< "5;7;1;0;00002D;;Vordere Lambdasonde Nr.2 Heizstrom;A;/255*10;2"
		<< "5;8;1;0;00002C;;Hintere Lambdasonde Heizstrom;A;/255*10;2"
		<< "6;1;1;0;00003B;;Kraftstoffpumpe Arbeitszyklus;%;/255*100;0"
		<< "6;2;1;0;00003A;;Lichtmaschine Arbeitszyklus;%;*1;0"
		<< "6;3;1;0;000039;;Abgasrückführung (EGR) Ventilschritte;Schritte;*1;0"
		<< "6;4;1;0;000038;;Leerlaufregelung (ISC) Ventilschritte;Schritte;*1;0"
		<< "6;5;1;0;000037;;Gemischwärmer Rbeitszyklus;%;/255*100;1"
		<< "6;6;1;0;000036;;Magergemischkorrektur;%;/255*100;0"
		<< "6;7;1;0;000035;;Leerlaufregelung (ISC) relative Einschaltdauer;%;/2;1"
		<< "6;8;1;0;000034;;Tumble-Ventil (TGV) Positionssensor (Links);V;/50;2"
		<< "7;1;1;0;000043;;Gemischsensor Nr.2 Strom;mA;-128/8;2"
		<< "7;2;1;0;000042;;Gemischsensor Nr.1 Strom;mA;-128/8;2"
		<< "7;3;1;0;000041;;Ölfluss-Steuermagnetventil (OCV) Strom (Links, Einlass);mA;*32;0"
		<< "7;4;1;0;000040;;Ölfluss-Steuermagnetventil (OCV) Strom (Rechts, Einlass);mA;*32;0"
		<< "7;5;1;0;00003F;;Ölfluss-Steuermagnetventil (OCV) Arbeitszyklus (Links, Einlass);%;/255*100;1"
		<< "7;6;1;0;00003E;;Ölfluss-Steuermagnetventil (OCV) Arbeitszyklus (Rechts, Einlass);%;/255*100;1"
		<< "7;7;1;0;00003D;;Variable Ventilsteuerung (VVT) Verstellwinkel (Links, Einlass);Grad;-50;0"
		<< "7;8;1;0;00003C;;Variable Ventilsteuerung (VVT) Verstellwinkel (Rechts, Einlass);Grad;-50;0"
		<< "8;1;1;0;0000D3;;Gemisch-Einstellspannung;V;/50;2"
		<< "8;2;1;0;0000D2;;Hintere Lambdasonde Heizspannung;V;/50;2"
		<< "8;3;1;0;0000D1;;Gemischlernwert 3;%;-128/128*100;2"
		<< "8;4;1;0;0000D0;;Gemischkorrektur 3;%;-64/128*10;2"
		<< "8;5;1;0;000047;;Gemischsensor Nr.2 Lambda;;/128;2"
		<< "8;6;1;0;000046;;Gemischsensor Nr.1 Lambda;;/128;2"
		<< "8;7;1;0;000045;;Gemischsensor Nr.2 Widerstand;Ohm;*1;0"
		<< "8;8;1;0;000044;;Gemischsensor Nr.1 Widerstand;Ohm;*1;0"
		<< "9;1;0;1;00004F;;Turbinendrehzahl;U/Min;*32;0"
		<< "9;2;0;1;00004E;;Drosselklappensensor Spannung;V;/45;2"
		<< "9;3;0;1;00004D;;Allradkupplung Taktverhältnis;%;/2;1"
		<< "9;4;0;1;00004C;;Überbrückungskupplung Taktverhältnis;%;/2;1"
		<< "9;5;0;1;00004B;;Hauptdruck Taktverhältnis;%;/2;1"
		<< "9;6;1;1;00004A;;Gang-Stellung;Gang;+1;0"
		<< "9;7;0;1;000049;;ATF-Temperatur;°C;0=-60,1=-60,2=-51,3=-45,4=-40,5=-37,6=-34,7=-31,8=-29,9=-27,10=-25,11=-23,12=-22,13=-20,14=-19,15=-17,16=-16,17=-15,18=-14,19=-13,20=-12,21=-10,22=-9,23=-9,24=-8,25=-7,26=-6,27=-5,28=-4,29=-3,30=-2,31=-2,32=-1,33=0,34=1,35=1,36=2,37=3,38=3,39=4,40=5,41=5,42=6,43=7,44=7,45=8,46=8,47=9,48=10,49=10,50=11,51=11,52=12,53=12,54=13,55=13,56=14,57=15,58=15,59=16,60=16,61=17,62=17,63=18,64=18,65=19,66=19,67=20,68=20,69=21,70=21,71=22,72=22,73=23,74=23,75=23,76=24,77=24,78=25,79=25,80=26,81=26,82=27,83=27,84=28,85=28,86=29,87=29,88=29,89=30,90=30,91=31,92=31,93=32,94=32,95=33,96=33,97=33,98=34,99=34,100=35,101=35,102=36,103=36,104=37,105=37,106=37,107=38,108=38,109=39,110=39,111=40,112=40,113=41,114=41,115=41,116=42,117=42,118=43,119=43,120=44,121=44,122=45,123=45,124=45,125=46,126=46,127=47,128=47,129=48,130=48,131=49,132=49,133=50,134=50,135=50,136=51,137=51,138=52,139=52,140=53,141=53,142=54,143=54,144=55,145=55,146=56,147=56,148=57,149=57,150=58,151=58,152=59,153=59,154=60,155=60,156=61,157=61,158=62,159=62,160=63,161=63,162=64,163=65,164=65,165=66,166=66,167=67,168=67,169=68,170=68,171=69,172=70,173=70,174=71,175=71,176=72,177=73,178=73,179=74,180=75,181=75,182=76,183=77,184=77,185=78,186=79,187=79,188=80,189=81,190=81,191=82,192=83,193=84,194=84,195=85,196=86,197=87,198=88,199=88,200=89,201=90,202=91,203=92,204=93,205=94,206=95,207=96,208=97,209=98,210=99,211=100,212=101,213=102,214=103,215=104,216=105,217=107,218=108,219=109,220=110,221=112,222=113,223=115,224=116,225=118,226=119,227=121,228=123,229=125,230=127,231=129,232=131,233=133,234=135,235=138,236=140,237=143,238=146,239=149,240=152,241=156,242=159,243=164,244=168,245=173,246=179,247=186,248=193,249=202,250=212,251=225,252=241,253=264,254=300,255=373;0"
		<< "9;8;0;1;000048;;Radgeschwindigkeit vorne;km/h;*1;0"
		<< "10;1;0;1;000057;;Niedriggang-Kupplung Arbeitszyklus;%;/2;1"
		<< "10;2;0;1;000056;;ATF-Temperatur;°C;-50;0"
		<< "10;3;0;1;000055;;Querbeschleunigungssensor Spannung;V;/50;2"
		<< "10;4;1;0;000054;;Gemischsensor Nr.2 Heizstrom;A;/10;1"
		<< "10;5;1;0;000053;;Gemischsensor Nr.1 Heizstrom;A;/10;1"
		<< "10;6;0;1;000052;;Krümmerdrucksensor Spannung;V;/50;2"
		<< "10;7;0;1;000051;;Radgeschwindigkeit hinten;km/h;*1;0"
		<< "10;8;0;1;000050;;Bremskupplung/Bremsband Taktverhälnis;%;/2;1"
		<< "11;1;0;1;00005F;;Angezeigter Zentraldifferential-Strom;A;/32;2"
		<< "11;2;0;1;00005E;;Tatsächlicher Zentraldifferential-Strom;A;/32;2"
		<< "11;3;0;1;00005D;;Automatikgetriebe Turbinendrehzahl 2;U/Min;*32;0"
		<< "11;4;0;1;00005C;;Automatikgetriebe Turbinendrehzahl 1;U/Min;*32;0"
		<< "11;5;0;1;00005B;;Spannung Zentraldifferential-Schalter;V;/51;2"
		<< "11;6;0;1;00005A;;ATF-Temperatur 2;°C;-50;0"
		<< "11;7;0;1;000059;;Bremse für Lastbereich und Rückwärtsgang (L&R B) Zyklus;%;/2;1"
		<< "11;8;0;1;000058;;Schnellgang-Kupplung Arbeitszyklus;%;/2;1"
		...
		<< "33;5;1;0;000103;;Haupt-Gaspedalsensor Spannung;V;/50;2"
		<< "33;6;1;1;000102;;Neben-Gaspedalsensor Spannung;V;/50;2"
		<< "33;7;1;0;000101;;Haupt-Drosselklappensensor Spannung;V;/50;2"
		<< "33;8;1;0;000100;;Neben-Drosselklappensensor Spannung;V;/50;2"
		<< "34;1;1;0;000173;000172;Kraftstofftankdruck;MPa;/100;1"
		<< "34;2;1;0;00010F;00010E;Wegstreckenzähler;km;*2;0"
		<< "34;3;1;0;00010D;;Kraftstoffstandsensor Widerstand;Ohm;*4/2;1"
		<< "34;4;1;0;00010C;;Gemischlernwert 4;%;-128/128*100;2"
		<< "34;5;1;0;00010B;;Gemischkorrektur 4;%;-64/128*10;2"
		<< "34;6;1;0;00010A;;Gespeicherte Zielgeschwindigkeit;km/h;*1;0"
		<< "34;7;1;0;000183;000182;Sekundärluft-Massenstrom;g/s;/100;2"
		<< "34;8;1;0;000108;;Sekundärluft-Druck;kPa;*1;0"
		<< "35;1;1;0;000117;;Öldruck-Schaltmagnetventil (OSV) Strom (Links);mA;*32;0"
		<< "35;2;1;0;000116;;Öldruck-Schaltmagnetventil (OSV) Strom (Rechts);mA;*32;0"
		<< "35;3;1;0;000115;;Öldruck-Schaltmagnetventil (OSV) Zyklus (Links);%;/255*100;1"
		<< "35;4;1;0;000114;;Öldruck-Schaltmagnetventil (OSV) Zyklus (Rechts);%;/255*100;1"
		<< "35;5;1;0;000113;;Öltemperatur;°C;-40;0"
		<< "36;2;1;0;00011E;;Variabler Ventilhub (VVL) Hubmodus;;*1;0"
		<< "36;3;1;0;00011D;;Ölfluss-Steuermagnetventil (OCV) Strom (Links, Auslass);mA;*32;0"
		<< "36;4;1;0;00011C;;Ölfluss-Steuermagnetventil (OCV) Strom (Rechts, Auslass);mA;*32;0"
		<< "36;5;1;0;00011B;;Ölfluss-Steuermagnetventil (OCV) Arbeitszyklus (Links, Auslass);%;/255*100;1"
		<< "36;6;1;0;00011A;;Ölfluss-Steuermagnetventil (OCV) Arbeitszyklus (Rechts, Auslass);%;/255*100;1"
		<< "36;7;1;0;000119;;Variable Ventilsteuerung (VVT) Verzögerungswinkel (Links, Auslass);Grad;-50;0"
		<< "36;8;1;0;000118;;Variable Ventilsteuerung (VVT) Verzögerungswinkel (Rechts, Auslass);Grad;-50;0"
		<< "43;1;0;1;000147;;Giergeschwindigkeitssensor Spannung;V;/51;2"
		<< "43;2;0;1;000146;;AWD-Magnetventil Strom;A;/255;2"
		<< "43;3;0;1;000145;;L/U-Magnetventil Strom;A;/255;2"
		<< "43;4;0;1;000144;;P/L-Magnetventil Strom;A;/255;2"
		<< "43;5;0;1;000143;;I/C-Magnetventil Strom;A;/255;2"
		<< "43;6;0;1;000142;;F/B-Magnetventil Strom;A;/255;2"
		<< "43;7;0;1;000141;;D/C-Magnetventil Strom;A;/255;2"
		<< "43;8;0;1;000140;;H&LR/C-Magnetventil Strom;A;/255;2"
		<< "44;1;0;1;00014F;;Giergeschwindigkeits- & Beschleunigungssensor Referenzspannung;V;/51;2"
		<< "44;2;0;1;00014E;;AWD-Magnetventil Druck;kPa;*10;0"
		<< "44;3;0;1;00014D;;L/U-Magnetventil Druck;kPa;*10;0"
		<< "44;4;0;1;00014C;;P/L-Magnetventil Druck;kPa;*10;0"
		<< "44;5;0;1;00014B;;I/C-Magnetventil Druck;kPa;*10;0"
		<< "44;6;0;1;00014A;;F/B-Magnetventil Druck;kPa;*10;0"
		<< "44;7;0;1;000149;;D/C-Magnetventil Druck;kPa;*10;0"
		...
		<< "45;8;0;1;00013C;;Radgeschwindigkeit vorne rechts;km/h;*1;0"
		<< "48;1;1;0;000199;;Klopfkorrektur;Grad;-128/4;1"
		<< "48;2;1;0;0000F9;;Gelernte Zündzeitpunkts-Korrektur;Grad;/16;1"
		<< "48;3;1;0;0000F8;;Rauhigkeit Zylinder #6;;*1;0"
		<< "48;4;1;0;0000EF;;Rauhigkeit Zylinder #5;;*1;0"
		<< "48;5;1;0;0000D9;;Rauhigkeit Zylinder #4;;*1;0"
		<< "48;6;1;0;0000D8;;Rauhigkeit Zylinder #3;;*1;0"
		<< "48;7;1;0;0000CF;;Rauhigkeit Zylinder #2;;*1;0"
		<< "48;8;1;0;0000CE;;Rauhigkeit Zylinder #1;;*1;0"
		<< "52;8;1;0;00019A;;Kraftstofftankdruck;kPa;-128/20;2"
		...
		<< "12;5;1;0;000061;Speicherlesemodussignal;Aus/Ein"
		<< "12;6;1;0;000061;Testmodussignal;Aus/Ein"
		<< "12;7;1;0;000061;Automatikgetriebe-Fahrzeug Identifierung;Aus/Ein"
		<< "13;2;1;0;000062;Klimaanlagenschalter;Aus/Ein"
		<< "13;3;1;0;000062;Servolenkungsschalter;Aus/Ein"
		<< "13;4;1;1;000062;Zündschalter;Aus/Ein"
		<< "13;5;1;0;000062;Ladeluftkühler-Befeuchtungsschalter;Aus/Ein"
		<< "13;7;1;0;000062;Leerlaufschalter;Aus/Ein"
		<< "13;8;1;1;000062;Neutralpositionsschalter;Aus/Ein"
		<< "14;1;1;0;000063;Elektrisches Belastungssignal;Aus/Ein"
		<< "14;2;1;0;000063;Klopfsignal 2;Aus/Ein"
		<< "14;3;1;0;000063;Klopfsignal 1;Aus/Ein"
		<< "14;4;1;0;000063;Vordere Lambdasonde 2 fett;Aus/Ein"
		<< "14;5;1;0;000063;Hintere Lambdasonde fett;Aus/Ein"
		<< "14;6;1;0;000063;Vordere Lambdasonde 1 fett;Aus/Ein"
		<< "14;7;1;0;000063;Anlasserschalter;Aus/Ein"
		<< "14;8;1;0;000063;Lenkradschalter;Hoher Eingang/Niedriger Eingang"
		<< "15;1;1;0;000064;Klimaanlagen-Mitteldruckschalter;Aus/Ein"
		<< "15;2;1;0;000064;Klimakompressor Einkupplungssignal;Aus/Ein"
		<< "15;3;1;0;000064;Wischerschalter;Aus/Ein"
		<< "15;4;1;0;000064;Lichtschalter;Aus/Ein"
		<< "15;5;1;0;000064;Gebläseschalter (Innenraum);Aus/Ein"
		<< "15;6;1;0;000064;Heckscheibenheizungsschalter;Aus/Ein"
		<< "15;7;1;0;000064;Nockenwellenpositionssignal;Aus/Ein"
		<< "15;8;1;0;000064;Kurbelwellenpositionssignal;Aus/Ein"
		<< "16;1;1;0;000065;Durchblasleck-Anschluss;Aus/Ein"
		<< "16;2;1;0;000065;Tankentlüftung (CPC) Aktivkohlebehälter-Magnetventil;Aus/Ein"
		<< "16;3;1;0;000065;Ladeluftkühler-Befeuchtungsrelais;Aus/Ein"
		<< "16;4;1;0;000065;Kraftstoffpumpenrelais;Aus/Ein"
		<< "16;5;1;0;000065;Kühlerlüfterrelais 2;Aus/Ein"
		<< "16;6;1;0;000065;Kühlerlüfterrelais 1;Aus/Ein"
		<< "16;7;1;0;000065;Kühlerlüfterrelais 3;Aus/Ein"
		<< "16;8;1;0;000065;Klimakompressorsignal;Aus/Ein"
		<< "17;1;1;0;000066;Zusatzluftmagnetventil;Aus/Ein"
		<< "17;2;1;0;000066;Servolenkungsmagnetventil;Aus/Ein"
		<< "17;3;1;0;000066;Belüftungsmagnetventil;Aus/Ein"
		<< "17;4;1;0;000066;Druckquellenwechsel;Aus/Ein"
		<< "17;5;1;0;000066;Variable Ansaugluft Magnetventil;Aus/Ein"
		<< "17;6;1;0;000066;Tumbleventil (TGV) Antrieb;Zu/Auf"
		<< "17;7;1;0;000066;Tumbleventil (TGV) Ausgang;Aus/Ein"
		<< "17;8;1;0;000066;Kurbelgehäuseentlüftung (PCV) Magnetventil;Aus/Ein"
		<< "18;1;1;0;000067;Schalldämpfersteuerung;Aus/Ein"
		<< "18;2;1;0;000067;Ansaugluftmagnetventil;Aus/Ein"
		<< "18;3;1;0;000067;Abgasunterdruck;Aus/Ein"
		<< "18;4;1;0;000067;Abgasüberdruck;Aus/Ein"
		<< "18;5;1;0;000067;Traktionskontrolle (TCS) Druckmindermagnetventil;Aus/Ein"
		<< "18;6;1;0;000067;Überdruckmagnetventil 2;Aus/Ein"
		<< "18;7;1;0;000067;Überdruckmagnetventil 1;Aus/Ein"
		<< "18;8;1;0;000067;Tanksensor-Steuerventil;Aus/Ein"
		<< "19;1;1;0;000068;Anforderung Drehmoment senken VDC;Aus/Ein"
		<< "19;2;1;0;000068;Sperre für Drehmomentsenkung;Ein/Aus"
		<< "19;3;1;0;000068;Automatikgetriebe Kraftstoff-Abschaltsignal;Aus/Ein"
		<< "19;4;1;0;000068;Automatikgetriebe Verzögerungssignal;Aus/Ein"
		<< "19;5;1;0;000068;Tankentlüftung (CPC) Magnetventil 2;Aus/Ein"
		<< "19;6;1;0;000068;Motoröldruckschalter 2;Aus/Ein"
		<< "19;7;1;0;000068;Motoröldruckschalter 1;Aus/Ein"
		<< "19;8;1;0;000068;Abgas-Bypassventil;Aus/Ein"
		<< "20;1;1;0;000069;Automatikgetriebe Motordrehmoment-Forderung (AET) Signal;Hoch/Niedrig"
		<< "20;2;1;0;000069;Automatikgetriebe-Koopeartion Fettgemischsignal;Aus/Ein"
		<< "20;3;1;0;000069;Automatikgetriebe-Kooperation Magergemischsignal;Aus/Ein"
		<< "20;4;1;0;000069;Automatikgetriebe-Kooperation Blockiersignal;Aus/Ein"
		<< "20;5;1;0;000069;Motor Automatikgetriebe Masking Flag (EAM) Signal;Hoch/Niedrig"
		<< "20;6;1;0;000069;Drehmomenterlaubnissignal;Aus/Ein"
		<< "20;7;1;0;000069;Drehmomentregelsignal 2;Aus/Ein"
		<< "20;8;1;0;000069;Drehmomentregelsignal 1;Aus/Ein"
		<< "21;1;0;1;00006A;Frontantrieb (FWD) Schalter;Aus/Ein"
		<< "21;2;1;1;00006A;Kick-Down-Schalter;Aus/Ein"
		<< "21;3;0;1;00006A;''Gang hoch''-Schalter;Aus/Ein"
		<< "21;4;0;1;00006A;Stoplichtschalter;Aus/Ein"
		<< "21;5;0;1;00006A;''Gang runter''-Schalter;Aus/Ein"
		<< "21;6;0;1;00006A;ABS-Signal;Aus/Ein"
		<< "21;7;0;1;00006A;Tempomatsignal;Aus/Ein"
		<< "21;8;0;1;00006A;Tiptronic-Betriebsschalter;Aus/Ein"
		<< "22;1;0;1;00006B;Neutral-/Parkstellungsschalter;Aus/Ein"
		<< "22;2;0;1;00006B;R-Stellungssignal;Aus/Ein"
		<< "22;3;0;1;00006B;D-Stellungssignal;Aus/Ein"
		<< "22;4;0;1;00006B;3er Gang Signal;Aus/Ein"
		<< "22;5;0;1;00006B;2er Gang Signal;Aus/Ein"
		<< "22;6;0;1;00006B;1er Gang Signal;Aus/Ein"
		<< "22;7;0;1;00006B;Hold-/Manuell-Schalter;Aus/Ein"
		<< "22;8;0;1;00006B;Power-Schalter;Aus/Ein"
		<< "23;1;0;1;00006C;Gangschalt-Magnetventil 1;Aus/Ein"
		<< "23;2;0;1;00006C;Gangschalt-Magnetventil 2;Aus/Ein"
		<< "23;3;0;1;00006C;Niedriggang-Kupplung Zeitsteuermagnetventil;Aus/Ein"
		<< "23;4;0;1;00006C;2-4-Bremse Zeitsteuermagnetventil;Aus/Ein"
		<< "23;5;0;1;00006C;Drehmomentregelsignal 2;Aus/Ein"
		<< "23;6;0;1;00006C;Drehmomentregelsignal 1;Aus/Ein"
		<< "23;7;0;1;00006C;Tiptronic Magnetventil;Aus/Ein"
		<< "23;8;0;1;00006C;4er Gang Signal;Aus/Ein"
		<< "24;1;0;1;00006D;Schaltsperrenmagnetventil;Aus/Ein"
		<< "24;2;0;1;00006D;ATF-Temperaturleuchte;Aus/Ein"
		<< "24;3;0;1;00006D;Hinterachsdifferential Öltemperaturschalter;Aus/Ein"
		<< "24;4;0;1;00006D;Diagnoseleuchte;Aus/Ein"
		<< "24;5;0;1;00006D;Gangwechsel-Schaltausgang 1;Aus/Ein"
		<< "24;6;0;1;00006D;Gangwechsel-Schaltausgang 2;Aus/Ein"
		<< "24;7;0;1;00006D;Gangwechsel-Schaltausgang 3;Aus/Ein"
		<< "24;8;0;1;00006D;Gangwechsel-Schaltausgang 4;Aus/Ein"
		<< "25;1;0;1;00006E;Neutralposition;Aus/Ein"
		<< "25;2;0;1;00006E;Hold Leuchte;Aus/Ein"
		<< "25;3;0;1;00006E;Traktionskontrolle (TCS) Schalter;Aus/Ein"
		<< "25;4;0;1;00006E;P/N Signal;Aus/Ein"
		<< "25;5;0;1;00006E;Drehmomentsteuerung Unterbrechungs-Signal;Aus/Ein"
		<< "25;6;0;1;00006E;Parkposition;Aus/Ein"
		<< "25;7;0;1;00006E;Power-Modus-Leuchte;Aus/Ein"
		<< "25;8;1;1;00006E;Economy-Schalter;Aus/Ein"
		<< "28;1;0;1;0000D4;Automatikgetriebe Leistungsrelais;Aus/Ein"
		<< "28;2;0;1;0000D4;Rückleuchtenrelais;Aus/Ein"
		<< "28;3;0;1;0000D4;Sperrschalter 3 Kontrolle;Niedrig/Hoch"
		<< "28;4;0;1;0000D4;Sperrschalter 4;Niedrig/Hoch"
		<< "28;5;0;1;0000D4;Sperrschalter 3;Niedrig/Hoch"
		<< "28;6;0;1;0000D4;Sperrschalter 2;Niedrig/Hoch"
		<< "28;7;0;1;0000D4;Sperrschalter 1;Niedrig/Hoch"
		<< "28;8;0;1;0000D4;Beurteilung Allradantrieb (AWD);Aus/Ein"
		<< "32;1;0;1;0000D5;Identifiziertes Steuergerät (ECM) Signal;Aus/Ein"
		<< "32;2;0;1;0000D5;LC/B Flüssigkeitsdruck;Aus/Ein"
		<< "32;3;0;1;0000D5;I/C Flüssigkeitsdruck;Aus/Ein"
		<< "32;4;0;1;0000D5;F/B Flüssigkeitsdruck;Aus/Ein"
		<< "32;5;0;1;0000D5;D/C Flüssigkeitsdruck;Aus/Ein"
		<< "32;6;0;1;0000D5;H&LR/C Flüssigkeitsdruck;Aus/Ein"
		<< "37;6;1;0;000120;Einspritzventil-Treiberrelais;Aus/Ein"
		<< "37;7;1;0;000120;Elektronische Drosselklappensteuerung (ETC) Motorrelais;Aus/Ein"
		<< "37;8;1;0;000120;Leerlaufschalter;Aus/Ein"
		<< "38;1;1;1;000121;Tempomat Status;Aus/Ein"
		<< "38;2;1;0;000121;Tempomat Hauptschalter (Cruise);Aus/Ein"
		<< "38;3;1;0;000121;Sperrschalter;Aus/Ein"
		<< "38;4;1;0;000121;Bremslichtschalter;Aus/Ein"
		<< "38;5;1;0;000121;Resume/Accel-Schalter;Aus/Ein"
		<< "38;6;1;0;000121;Set/Coast-Schalter;Aus/Ein"
		<< "38;7;1;0;000121;Stopplichtschalter;Aus/Ein"
		<< "38;8;1;0;000121;Kupplungsschalter;Aus/Ein"
		<< "39;1;0;1;000122;Zentraldifferential-Anzeige Leuchte 6;Aus/Ein"
		<< "39;2;0;1;000122;Zentraldifferential-Anzeige Leuchte 5;Aus/Ein"
		<< "39;3;0;1;000122;Zentraldifferential-Anzeige Leuchte 4;Aus/Ein"
		<< "39;4;0;1;000122;Zentraldifferential-Anzeige Leuchte 3;Aus/Ein"
		<< "39;5;0;1;000122;Zentraldifferential-Anzeige Leuchte 2;Aus/Ein"
		<< "39;6;0;1;000122;Zentraldifferential-Anzeige Leuchte 1;Aus/Ein"
		<< "39;7;0;1;000122;LU&FWD/B Magnetventil;Aus/Ein"
		<< "39;8;0;1;000122;LC/B Magnetventil;Aus/Ein"
		<< "46;4;0;1;0000D6;Hydraulikdruck-Schalter Vorw./B;Aus/Ein"
		<< "46;5;0;1;0000D6;AUTO-Modus Kontrolleuchte;Aus/Ein"
		<< "46;6;0;1;0000D6;AUTO/MANUAL Schalter;Aus/Ein"
		<< "46;7;0;1;0000D6;Zentraldifferentialrelais;Aus/Ein"
		<< "46;8;0;1;0000D6;Parkpositionsschalter;Aus/Ein"
		<< "47;1;1;0;0000D7;Geschwindigkeitsregelanlage Abstellschalter;Aus/Ein"
		<< "47;2;1;0;0000D7;Abstands-Änderungsschalter;Aus/Ein"
		<< "47;3;1;0;0000D7;Sekundärluft-Kombiventil Relais 1;Aus/Ein"
		<< "47;4;1;0;0000D7;Sekundärluftpumpe Relais;Aus/Ein"
		...
		<< "000095;0000AB;2;??;UNBEKANNT (Adresse 95/AB Bit 2)"
		...
		<< "000098;0000AE;1;??;UNBEKANNT (Adresse 98/AE Bit 1)"
		<< "000098;0000AE;2;??;UNBEKANNT (Adresse 98/AE Bit 2)"
		<< "000098;0000AE;3;??;UNBEKANNT (Adresse 98/AE Bit 3)"
		<< "000098;0000AE;4;??;UNBEKANNT (Adresse 98/AE Bit 4)"
		<< "000098;0000AE;5;??;UNBEKANNT (Adresse 98/AE Bit 5)"
		<< "000098;0000AE;6;??;UNBEKANNT (Adresse 98/AE Bit 6)"
		<< "000098;0000AE;7;??;UNBEKANNT (Adresse 98/AE Bit 7)"
		<< "000098;0000AE;8;??;UNBEKANNT (Adresse 98/AE Bit 8)";
		...
		<< "00008E;0000AE;6;P????;UNBEKANNT (Adresse 8E/AE Bit 6)"
		<< "00008E;0000AE;7;P0604;Fehler im RAM-Speicher des internen Steuermoduls"
		<< "00008E;0000AE;8;P0601;Intern.Regel/Speicher Modul ECM Fehlfunktion"
		...
		<< "00008F;0000AF;3;P1141;Bereich/Leistung des Masse- oder Vol.-Luftmengensensors (niedrig)"
		...
		<< "000093;0000B3;3;P????;UNBEKANNT (Adresse 93/B3 Bit 3)"
		<< "000093;0000B3;4;P0451;Kraftstofftankdrucksens.funktion Problem"
		...
		<< "000094;0000B4;5;P0182;Kraftstofftemperatursensorfunktion A Schaltkr.Eingangssignal niedrig"
		<< "000094;0000B4;6;P0183;Kraftstofftemperatursensorfunktion A Schaltkr.Eingangssignal hoch"
		...
		<< "00009E;0000BE;2;P1707;Störung im Allradantr.Solenoid- ventilkreis (Automatikgetriebe)"
		...
		<< "0000A5;0000C5;5;P0107;Störung des Krümmerdruck-Sensorkreises (niedriger Eing.)"
		...
		<< "0000A8;0000C8;2;P1491;Funktionsstörung d. pos. Kurbelgehäuseentlüftung (Durchblasen)"
		...
		<< "0000AA;0000CA;8;P1247;Kreis von Überdruckventil-Steuermagnetventil 1 (niedrig)"
		<< "0000AB;0000CB;1;P1577;WFS-Steuergerät defekt EEPROM"
		<< "0000AB;0000CB;2;P1576;EGI-Steuergerät EEPROM Fehlfunktion"
		<< "0000AB;0000CB;3;P0513;Falsche Taste zum Unbeweglichmachen"
		<< "0000AB;0000CB;4;P1574;Schlüssel-Kommunikationsfehler"
		<< "0000AB;0000CB;5;P1578;Instrumentenstörung"
		<< "0000AB;0000CB;6;P1572;Systemkreisunterbrechung der WFS (ausgenommen Antennenstromkreis)"
		<< "0000AB;0000CB;7;P1571;Bezugscode fehlerhaft"
		<< "0000AB;0000CB;8;P1570;Antenne"
		<< "0000AC;0000CC;1;P1095;Störung im TGV1-Signalkreis (Kurzschluss)"
		<< "0000AC;0000CC;2;P1097;Störung im TGV2-Signalkreis (Kurzschluss)"
		<< "0000AC;0000CC;3;P1094;Störung im TGV1-Signalkreis (Offen)"
		<< "0000AC;0000CC;4;P1096;Störung im TGV2-Signalkreis (Offen)"
		<< "0000AC;0000CC;5;P0261;Einspritzventilschaltkreis Signal niedrig - #1"
		<< "0000AC;0000CC;6;P0264;Einspritzventilschaltkreis Signal niedrig - #2"
		<< "0000AC;0000CC;7;P0267;Einspritzventilschaltkreis Signal niedrig - #3"
		<< "0000AC;0000CC;8;P0270;Einspritzventilschaltkreis Signal niedrig - #4"
		...
		<< "0000AD;0000CD;5;P1306;Störung im Signalkreis von OCV- Solenoid 1 (Offen)"
		<< "0000AD;0000CD;6;P1308;Störung im Signalkreis von OCV- Solenoid 2 (Offen)"
		<< "0000AD;0000CD;7;P1307;Störung im Signalkreis von OCV- Solenoid 1 (Kurzschluss)"
		<< "0000AD;0000CD;8;P1309;Störung im Signalkreis von OCV- Solenoid 2 (Kurzschluss)"
		...
		<< "0000F0;0000F4;5;P1086;Kreis von TGV-Positionssensor 2 (niedrig)"
		<< "0000F0;0000F4;6;P1087;Kreis von TGV-Positionssensor 2 (hoch)"
		<< "0000F0;0000F4;7;P1088;Kreis von TGV-Positionssensor 1 (niedrig)"
		<< "0000F0;0000F4;8;P1089;Kreis von TGV-Positionssensor 1 (hoch)"
		...
		<< "000124;00012C;7;P1769;Giermoment- G-Sensor-Fehler"
		...
		<< "000160;000165;1;P0028;Störung des OSV-Magnetventils links"
		<< "000160;000165;2;P0083;Störung im Kreis des OSV- Solenoidventils links (hoch)"
		<< "000160;000165;3;P0082;Störung im Kreis des OSV- Solenoidventils links (niedrig)"
		<< "000160;000165;4;P0026;Störung des OSV-Magnetventils rechts"
		<< "000160;000165;5;P0077;Störung im Kreis des OSV- Solenoidventils rechts (hoch)"
		<< "000160;000165;6;P0076;Störung im Kreis des OSV- Solenoidventils rechts (niedrig)"
		...
		<< "000162;000167;8;P1601;TCU Kommunikationsstörung"
		<< "000163;000168;1;P2004;TGV-System 1 (Ventil offen)"
		<< "000163;000168;2;P2006;TGV-System 1 (Ventil geschlossen)"
		<< "000163;000168;3;P2005;TGV-System 2 (Ventil offen)"
		<< "000163;000168;4;P2007;TGV-System 2 (Ventil geschlossen)"
		...
		<< "000164;000169;1;P2016;Kreis von TGV-Positionssensor 1 (niedrig)"
		<< "000164;000169;2;P2017;Kreis von TGV-Positionssensor 1 (hoch)"
		<< "000164;000169;3;P2021;Kreis von TGV-Positionssensor 2 (niedrig)"
		<< "000164;000169;4;P2022;Kreis von TGV-Positionssensor 2 (hoch)"
		<< "000164;000169;5;P2009;Störung im TGV1-Signalkreis (Kurzschluss)"
		<< "000164;000169;6;P2012;Störung im TGV2-Signalkreis (Kurzschluss)"
		<< "000164;000169;7;P2008;Störung im TGV1-Signalkreis (Offen)"
		<< "000164;000169;8;P2011;Störung im TGV2-Signalkreis (Offen)"
		<< "000174;00017B;1;P1579;Fernanlassfunktion abnormal"
		<< "000174;00017B;2;P????;UNBEKANNT (Adresse 174/17B Bit 2)"
		<< "000174;00017B;3;P????;UNBEKANNT (Adresse 174/17B Bit 3)"
		<< "000174;00017B;4;P????;UNBEKANNT (Adresse 174/17B Bit 4)"
		<< "000174;00017B;5;P????;UNBEKANNT (Adresse 174/17B Bit 5)"
		<< "000174;00017B;6;P????;UNBEKANNT (Adresse 174/17B Bit 6)"
		<< "000174;00017B;7;P????;UNBEKANNT (Adresse 174/17B Bit 7)"
		<< "000174;00017B;8;P????;UNBEKANNT (Adresse 174/17B Bit 8)"
		<< "000175;00017C;1;P0850;Neutralpositionsschalterkreis"
		<< "000175;00017C;2;P1721;DCCD Motordrehzahlsignal Systemkreislauf"
		<< "000175;00017C;3;P1720;DCCD CAN Systemkreislauf"
		<< "000175;00017C;4;P1765;Giermoment-&G-Sensor Referenzspannung Systemkreislauf"
		...
		<< "000177;00017E;4;P1602;Steuergerät-Programmierfehler"
		...
		<< "000179;000180;1;P0024;AVCS-Auspuffsystem 2 (Bereich/Leistung)"
		<< "000179;000180;2;P0014;AVCS-Auspuffsystem 1 (Bereich/Leistung)"
		...
		<< "00017A;000181;3;P????;UNBEKANNT (Adresse 17A/181 Bit 3)"
		<< "00017A;000181;4;P????;UNBEKANNT (Adresse 17A/181 Bit 4)"
		...
		<< "0001C1;0001C7;1;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 1)"
		<< "0001C1;0001C7;2;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 2)"
		<< "0001C1;0001C7;3;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 3)"
		<< "0001C1;0001C7;4;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 4)"
		<< "0001C1;0001C7;5;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 5)"
		<< "0001C1;0001C7;6;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 6)"
		<< "0001C1;0001C7;7;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 7)"
		<< "0001C1;0001C7;8;P????;UNBEKANNT (Adresse 1C1/1C7 Bit 8)"
		<< "0001C2;0001C8;1;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 1)"
		<< "0001C2;0001C8;2;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 2)"
		<< "0001C2;0001C8;3;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 3)"
		<< "0001C2;0001C8;4;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 4)"
		<< "0001C2;0001C8;5;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 5)"
		<< "0001C2;0001C8;6;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 6)"
		<< "0001C2;0001C8;7;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 7)"
		<< "0001C2;0001C8;8;P????;UNBEKANNT (Adresse 1C2/1C8 Bit 8)"
		<< "0001C3;0001C9;1;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 1)"
		<< "0001C3;0001C9;2;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 2)"
		<< "0001C3;0001C9;3;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 3)"
		<< "0001C3;0001C9;4;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 4)"
		<< "0001C3;0001C9;5;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 5)"
		<< "0001C3;0001C9;6;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 6)"
		<< "0001C3;0001C9;7;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 7)"
		<< "0001C3;0001C9;8;P????;UNBEKANNT (Adresse 1C3/1C9 Bit 8)"
		<< "0001C4;0001CA;1;P????;UNBEKANNT (Adresse 1C4/1CA Bit 1)"
		<< "0001C4;0001CA;2;P????;UNBEKANNT (Adresse 1C4/1CA Bit 2)"
		<< "0001C4;0001CA;3;P????;UNBEKANNT (Adresse 1C4/1CA Bit 3)"
		<< "0001C4;0001CA;4;P????;UNBEKANNT (Adresse 1C4/1CA Bit 4)"
		<< "0001C4;0001CA;5;P????;UNBEKANNT (Adresse 1C4/1CA Bit 5)"
		...
		<< "0001C5;0001CB;5;P????;UNBEKANNT (Adresse 1C5/1CB Bit 5)"
		<< "0001C5;0001CB;6;P????;UNBEKANNT (Adresse 1C5/1CB Bit 6)"
		<< "0001C5;0001CB;7;P????;UNBEKANNT (Adresse 1C5/1CB Bit 7)"
		<< "0001C5;0001CB;8;P????;UNBEKANNT (Adresse 1C5/1CB Bit 8)"
		<< "0001C6;0001CC;1;P????;UNBEKANNT (Adresse 1C6/1CC Bit 1)"
		<< "0001C6;0001CC;2;P????;UNBEKANNT (Adresse 1C6/1CC Bit 2)"
		...
		<< "00020A;00020E;4;P????;UNBEKANNT (Adresse 20A/20E Bit 4)"
		<< "00020A;00020E;5;P????;UNBEKANNT (Adresse 20A/20E Bit 5)"
		<< "00020A;00020E;6;P????;UNBEKANNT (Adresse 20A/20E Bit 6)"
		<< "00020A;00020E;7;P????;UNBEKANNT (Adresse 20A/20E Bit 7)"
		<< "00020A;00020E;8;P????;UNBEKANNT (Adresse 20A/20E Bit 8)"
		<< "00020B;00020F;1;P????;UNBEKANNT (Adresse 20B/20F Bit 1)"
		<< "00020B;00020F;2;P????;UNBEKANNT (Adresse 20B/20F Bit 2)"
		<< "00020B;00020F;3;P????;UNBEKANNT (Adresse 20B/20F Bit 3)"
		<< "00020B;00020F;4;P????;UNBEKANNT (Adresse 20B/20F Bit 4)"
		<< "00020B;00020F;5;P????;UNBEKANNT (Adresse 20B/20F Bit 5)"
		...
		<< "00020C;000210;6;P????;UNBEKANNT (Adresse 20C/210 Bit 6)"
		<< "00020C;000210;7;P????;UNBEKANNT (Adresse 20C/210 Bit 7)"
		<< "00020C;000210;8;P????;UNBEKANNT (Adresse 20C/210 Bit 8)"
		<< "00020D;000211;1;P????;UNBEKANNT (Adresse 20D/211 Bit 1)"
		<< "00020D;000211;2;P????;UNBEKANNT (Adresse 20D/211 Bit 2)"
		<< "00020D;000211;3;P????;UNBEKANNT (Adresse 20D/211 Bit 3)"
		<< "00020D;000211;4;P????;UNBEKANNT (Adresse 20D/211 Bit 4)"
		...
		<< ";;000089;5;Klimakompressorrelais"
		<< ";;000089;4;Abgasrückführung (EGR) Magnetventil"
		<< ";;000089;3;Saugluftmagnetventil (ASV)"
		<< ";;000089;2;Kurbelgehäuseentlüftung (PCV) Magnetventil"
		<< ";;000089;1;Belüftungsmagnetventil"
		<< ";;00008A;8;Leerlaufanhebung (FICD) Magnetventil"
		<< ";;00008A;7;Druckschaltmagnetventil 1"
		<< ";;00008A;6;Druckschaltmagnetventil 2"
		<< ";;00008A;5;Magnetventil für luftunterstütze Einspritzventile (AAI)"
		<< ";;00008A;4;Kraftstofftanksensor-Steuerventil"
		<< ";;00008A;3;Turbolader Wastegate-Magnetventil"
		<< ";;00008A;2;Genehmigungszeichen für Abgas-Bypassregelung"
		<< ";;00008A;1;Sekundärluft-Kombiventil 1"

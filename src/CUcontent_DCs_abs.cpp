/*
 * CUcontent_DCs_abs.cpp - Widget for TCU Diagnostic Codes Reading
 *
...
#include "CUcontent_DCs_abs.h"


CUcontent_DCs_abs::CUcontent_DCs_abs(QWidget *parent) : CUcontent_DCs_abstract(parent)
{
...
CUcontent_DCs_abs::~CUcontent_DCs_abs()
{
...
bool CUcontent_DCs_abs::setup(SSMprotocol *SSMPdev)
{
	bool ok = false;
...
void CUcontent_DCs_abs::connectGUIelements()
{
	if (!_SSMPdev) return;
...
void CUcontent_DCs_abs::disconnectGUIelements()
{
...
void CUcontent_DCs_abs::updateCurrentOrTemporaryDTCsContent(QStringList currOrTempDTCs, QStringList currOrTempDTCdescriptions)
{
...
void CUcontent_DCs_abs::updateHistoricOrMemorizedDTCsContent(QStringList histOrMemDTCs, QStringList histOrMemDTCdescriptions)
{
...
void CUcontent_DCs_abs::createDCprintTables(QTextCursor cursor)
{
...
void CUcontent_DCs_abs::resizeEvent(QResizeEvent *event)
{
...
bool CUcontent_DCs_abs::eventFilter(QObject *obj, QEvent *event)
{
...
void CUcontent_DCs_abs::setupUiFonts()
{
	// SET FONT FAMILY AND FONT SIZE
	// OVERWRITES SETTINGS OF ui_CUcontent_DCs_abs.h (made with QDesigner)

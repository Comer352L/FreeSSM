/*
 * CUinfo_AirCon.cpp - Widget for displaying AirCon Control Unit information
 *
...
CUinfo_AirCon::CUinfo_AirCon(QWidget * parent) : QWidget(parent)
{
	setupUi(this);
	setupUiFonts();
}
...
CUinfo_AirCon::~CUinfo_AirCon()
{
}


void CUinfo_AirCon::setAirConTypeText(QString Type)
{
	aircontype_label->setText(Type);
}


void CUinfo_AirCon::setRomIDText(QString RomID)
{
	romID_label->setText(RomID);
}


void CUinfo_AirCon::setNrOfSupportedMBsSWs(unsigned int MBs, unsigned int SWs)
{
...
void CUinfo_AirCon::setupUiFonts()
{
	// SET FONT FAMILY AND FONT SIZE
	// OVERWRITES SETTINGS OF ui_CUinfo_AirCon.h (made with QDesigner)
	QFont appfont = QApplication::font();
	QFont font = this->font();
	font.setFamily(appfont.family());
	font.setPixelSize(12);	// 9pts
	this->setFont(font);
	font = aircontypetitle_label->font();
	font.setFamily(appfont.family());
	font.setPixelSize(12);	// 9pts
	aircontypetitle_label->setFont(font);
	font = aircontype_label->font();
	font.setFamily(appfont.family());
	font.setPixelSize(12);	// 9pts
	aircontype_label->setFont(font);

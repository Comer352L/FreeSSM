...
bool AirConDialog::setup(enum mode_dt mode)
{
	// *** Local variables:
...
void AirConDialog::switchToDCsMode()
{
	bool ok = false;
...
void AirConDialog::switchToMBsSWsMode()
{
	bool ok = false;
...
bool AirConDialog::startDCsMode()
{
	int DCgroups = 0;
...
bool AirConDialog::startMBsSWsMode()
{

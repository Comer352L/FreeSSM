/*
 * CUcontent_DCs_abs.h - Widget for TCU Diagnostic Codes Reading
 *
...
#ifndef CUCONTENT_DCS_ABS_H
#define CUCONTENT_DCS_ABS_H


#include <QtGui>
#include <string>
#include "CUcontent_DCs_abstract.h"
#include "ui_CUcontent_DCs_abs.h"
#include "SSMprotocol2.h"


class CUcontent_DCs_abs : public CUcontent_DCs_abstract, private Ui::absDCcontent_Form
{
	Q_OBJECT

public:
	CUcontent_DCs_abs(QWidget *parent = 0);
	~CUcontent_DCs_abs();

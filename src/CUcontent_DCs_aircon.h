/*
 * CUcontent_DCs_aircon.h - Widget for TCU Diagnostic Codes Reading
 *
...
#ifndef CUCONTENT_DCS_AIRCON_H
#define CUCONTENT_DCS_AIRCON_H


#include <QtGui>
#include <string>
#include "CUcontent_DCs_abstract.h"
#include "ui_CUcontent_DCs_aircon.h"
#include "SSMprotocol2.h"


class CUcontent_DCs_aircon : public CUcontent_DCs_abstract, private Ui::airconDCcontent_Form
{
	Q_OBJECT

public:
	CUcontent_DCs_aircon(QWidget *parent = 0);
	~CUcontent_DCs_aircon();
